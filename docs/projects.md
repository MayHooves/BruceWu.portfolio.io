# Portfolio
Text in green can be clicked for navigation.
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin: 20px 0;">
  ...
  <div style="text-align: center;">
    <a href=" ./portfolio/sculpting-smolder.html">
    <img src="/SmolderSculpt/SmolderSideFront.jpg" style="width: 100%; object-fit: cover; border-radius: 8px;" />
    <p style="margin-top: 8px; font-weight: bold;">Smolder Head Sculpter</p>
    </a>
  </div>
